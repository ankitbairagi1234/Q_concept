...
import 'package:eclass/screens/institute_profile_screen.dart';
    ...
    return SliverToBoxAdapter(
      child: Container(
        ...
        child: Swiper(
              ...
              child: GestureDetector(
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => InstituteProfileScreen(
                        instituteId: slider.instituteModel.institute[index].id,
                ...
                child: Stack(
                  children: [
                    ...
                    detailsOnImage(slider.instituteModel.institute[index].title,
          ...
          autoplay: true,
          itemCount: slider.instituteModel.institute.length,
        ),
      ),
    );
  }
