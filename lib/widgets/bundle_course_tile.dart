                  ...
                  children: [
                      ...
                      children: [
                        ...
                        if (bundleCoursesDetail.discountPrice != null &&
                          ...
                          Column(
                            children: [
                              Text(
                                "${currencySymbol(selectedCurrency)} ${(num.parse(bundleCoursesDetail.discountPrice.toString()) * selectedCurrencyRate)}",
                                style: TextStyle(
                                    color: mode.txtcolor,
                                    fontSize: 18.0,
                                    fontWeight: FontWeight.bold),
                    ...
                    if (bundleCoursesDetail.price != null && !purchased)
                      Align(
                        ...
                        child: Text(
                          "${currencySymbol(selectedCurrency)} ${(num.parse(bundleCoursesDetail.price.toString()) * selectedCurrencyRate)}",
                          style: TextStyle(
                              decoration:
