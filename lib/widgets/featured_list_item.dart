                                ...
                                children: [
                                  courseDetail.discountPrice == null
                                      ...
                                      : isPurchased
                                          ...
                                          : Text(
                                              "${currencySymbol(selectedCurrency)} ${(num.parse(courseDetail.discountPrice.toString()) * selectedCurrencyRate)}",
                                              maxLines: 2,
                                              style: TextStyle(
                                                  color: mode.txtcolor,
                                                  fontSize: 18.0,
                          ...
                          Align(
                            ...
                            child: courseDetail.price == null
                                ...
                                : isPurchased
                                    ...
                                    : Text(
                                        "${currencySymbol(selectedCurrency)} ${(num.parse(courseDetail.price.toString()) * selectedCurrencyRate)}",
                                        style: TextStyle(
                                            decoration:
