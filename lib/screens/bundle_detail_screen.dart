                  ...
                  Row(
                    ...
                    children: [
                      if (bundleDetail.discountPrice != null)
                        Text(
                            "${currencySymbol(selectedCurrency)} ${(num.parse(bundleDetail.discountPrice.toString()) * selectedCurrencyRate)}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 22.0,
                                color: Color(0xff404455))),
                      ...
                      Text(
                        "${currencySymbol(selectedCurrency)} ${(num.parse(bundleDetail.price.toString()) * selectedCurrencyRate)}",
                        style: TextStyle(
